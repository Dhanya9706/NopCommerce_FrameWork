...
class ConfigDiscovery:
    ...
    def __call__(self, force=False, name=True, ignore_ext_modules=False):
        """Automatically discover missing configurations fields
    ...
    def _explicitly_specified(self, ignore_ext_modules: bool) -> bool:
        ...
        return (
            ...
            or ext_modules
            or hasattr(self.dist, "configurations") and self.dist.configuration
    ...
    def _analyse_package_layout(self, ignore_ext_modules: bool) -> bool:
        ...
        log.debug(
            "No `packages` or `py_modules` configurations, performing "
            "automatic discovery."
        )
    ...
    def analyse_name(self):
        ...
        log.debug("No `name` configurations, performing automatic discovery")
