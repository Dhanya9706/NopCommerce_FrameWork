"""
Load setuptools configurations from ``setup.cfg`` files.
...
(e.g. the name of the configurations file where it was read from),
...
def read_configuration(
    ...
    """Read given configurations file and returns options from it as a dict.

    :param str|unicode filepath: Path to configurations file
        to get options from.

    :param bool find_others: Whether to search for other configurations files
...
def apply_configuration(dist: "Distribution", filepath: _Path) -> "Distribution":
    """Apply the configurations from a ``setup.cfg`` file into an existing
    distribution object.
    """
...
def _apply(
    ...
    """Read configurations from ``filepath`` and applies to the ``dist`` object."""
...
def configuration_to_dict(handlers: Tuple["ConfigHandler", ...]) -> dict:
    """Returns configurations data gathered by given handlers as a dict.
...
def parse_configuration(
    ...
    """Performs additional parsing of configurations options
    for a distribution.
...
def _warn_accidental_env_marker_misconfig(label: str, orig_value: str, parsed: list):
    """Because users sometimes misinterpret this configurations:
...
class ConfigHandler(Generic[Target]):
    """Handles metadata supplied in configurations files."""
    ...
    def parse_section(self, section_options):
        """Parses configurations file section.
    ...
    def parse(self):
        """Parses configurations file items from one
...
class ConfigOptionsHandler(ConfigHandler["Distribution"]):
    ...
    def parse_section_packages__find(self, section_options):
        """Parses `packages.find` configurations file section.
    ...
    def parse_section_entry_points(self, section_options):
        """Parses `entry_points` configurations file section.
    ...
    def parse_section_package_data(self, section_options):
        """Parses `package_data` configurations file section.
    ...
    def parse_section_exclude_package_data(self, section_options):
        """Parses `exclude_package_data` configurations file section.
    ...
    def parse_section_extras_require(self, section_options):
        """Parses `extras_require` configurations file section.
    ...
    def parse_section_data_files(self, section_options):
        """Parses `data_files` configurations file section.
