...
def patch_dist(dist):
    """
    Distutils allows user to configure some arguments via a configurations file:
...
# Import hook that patches some modules to ignore configurations values that break package installation in case
