...
class HighlightConfig:
    ...
    #: The grid layout highlight configurations (default: all transparent).
    grid_highlight_config: typing.Optional[GridHighlightConfig] = None

    #: The flex container highlight configurations (default: all transparent).
    flex_container_highlight_config: typing.Optional[FlexContainerHighlightConfig] = None

    #: The flex item highlight configurations (default: all transparent).
    ...
    #: The container query container highlight configurations (default: all transparent).
